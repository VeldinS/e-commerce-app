...
function Landing() {
    return (
        <section className="h-screen bg-light-gray flex flex-col md:flex-row md:justify-between justify-center items-center md:gap-0 gap-8 py-24 overflow-hidden relative lg:px-36 md:px-24 px-10">
