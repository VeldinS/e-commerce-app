...
function Landing() {
    return (
        <section className="h-screen bg-light-gray flex flex-col md:flex-row md:justify-between justify-center items-center md:gap-0 gap-8 py-24 overflow-hidden relative xl:px-36 lg:px-24 px-10">
            ...
            <div className="md:w-1/2 w-full flex flex-col md:items-start items-center justify-center md:gap-16 gap-8">
                ...
                <div className="w-4/5 flex flex-col md:items-start items-center justify-center md:gap-12 gap-4">
